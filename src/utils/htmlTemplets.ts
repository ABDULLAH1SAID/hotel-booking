...
import { EmailTemplateOptions } from '../types/htmlTemplats.interface'

export const signUpTemplate = (confirmationLink: string): string => `
<!DOCTYPE html>
<html>
<head>
...
export const resetPasswordTemplate = (resetCode: string): string => `
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
export const generateSignUpTemplate = (
  ...
  return signUpTemplate(confirmationLink).replace(
    'Your Company Name', 
    companyName
  );
};
...
export const generateResetPasswordTemplate = (
  ...
  return resetPasswordTemplate(resetCode).replace(
    'Your Company Name',
    companyName
  );
};